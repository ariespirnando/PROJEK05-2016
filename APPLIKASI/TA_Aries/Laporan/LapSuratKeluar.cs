...
{
    public partial class LapSuratKeluar : Form
    {
        public LapSuratKeluar()
        {
            InitializeComponent();
            setingtanggal();
        }
        ...
        private void LapSuratKeluar_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'dataSet2.DataTable1' table. You can move, or remove it, as needed.
            this.dataTable1TableAdapter.Fill(this.dataSet2.DataTable1,tanggalAwal.Text,tanggalAkhir.Text);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            this.dataTable1TableAdapter.Fill(this.dataSet2.DataTable1, tanggal, tanggal2);
            this.reportViewer1.RefreshReport();
        }
