...
namespace TA_Aries
{
    public partial class formArsipKeluar : Form
    {
        ...
        public void isidata()
        {
            ...
            {
                kon.Open();
                sql = "Select nomorSurat from ArsipSuratKel";
        ...
        public void caridata()
        {
            ...
            {
                kon.Open();
                sql = "Select nomorSurat from ArsipSuratKel where nomorSurat like '%" + nosurat.Text + "%'";
                cmd = new SqlCommand(sql, kon);
                cmd.ExecuteNonQuery();
        ...
        private void listarsipsuratmasuk_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            {
                kon.Open();
                sql = "Select GambarSk from ArsipSuratKel WHERE nomorSurat ='" + Nomorsurat + "'";
                cmd = new SqlCommand(sql, kon);
                cmd.ExecuteNonQuery();
        ...
        private void listarsipsuratmasuk_SelectedIndexChanged(object sender, EventArgs e)
        {
