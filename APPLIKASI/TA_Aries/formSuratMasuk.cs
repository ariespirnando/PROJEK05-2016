...
// Mengimport apa saja yang dibutuhkan dalam form surat

namespace TA_Aries
{
    public partial class formSuratMasuk : Form
    {
        /* Membuat variabel yang digunakan untuk proses manipulasi data */
        ...
        //-----------------------------------------------------------------------
        /* digunakan untuk menampilkan list kode surat */
        ...
        //----------------------------------------------------------
        /* fungsi untuk membersihkan text box pada sistem */
        public void bersih()
        {
            txtnomrsurat.Clear();
        ...
        //-----------------------------------------------------------
        /* fungsi untuk men enable kan komponen-komponen pada form */
        ...
        //-----------------------------------------------------------
        /* fungsi untuk men disable kan komponen-komponen pada form */
        ...
        //-----------------------------------------------------------
        /* fungsi untuk memformat tanggal dan set pada hari ini */
        ...
        //-----------------------------------------------------------
        /* fungsi menyimpan data yang akan disimpan ke database */
        public void simpan()
        {
            ...
            {
                kon.Open();
                sql = "INSERT INTO SuratMasuk VALUES('" + txtnomrsurat.Text + "','" + txtprihal.Text + "','"+tanggal+"','"+txtpengirim.Text+"','"+txtalamat.Text+"','"+txtpenerima.Text+"','"+txtkodesurat.Text+"')";
                sqlGambar = "INSERT INTO ArsipSurat VALUES ('" + txtnomrsurat.Text + "',@img)";
                cmd = new SqlCommand(sql, kon);
        ...
        public void Edit()
        {
            ...
            try
            {
                //, tanggalSM = '" + tanggal + "',
                kon.Open();
                sql = "UPDATE SuratMasuk SET prihalSM ='" + txtprihal.Text + "', PengirimSM = '" + txtpengirim.Text + "', tanggalSM = '" + tanggal + "', " +
                "alamatSM = '" + txtalamat.Text + "', penerimaSM = '" + txtpenerima.Text + "', kodeSurat = '" + txtkodesurat.Text + "'"+
                "WHERE nomorSurat = '"+txtnomrsurat.Text+"' ";
                cmd = new SqlCommand(sql, kon);

                sqlGambar = "UPDATE ArsipSurat SET Gambar = @img WHERE nomorSurat ='" + txtnomrsurat.Text + "'";
                cmdGambar = new SqlCommand(sqlGambar, kon);
                cmdGambar.Parameters.Add(new SqlParameter("@img", SqlDbType.Image)).Value = arrImage;
        ...
        public void hapus()
        {
            ...
            {
                kon.Open();
                sql = "DELETE SuratMasuk WHERE nomorSurat = '" + txtnomrsurat.Text + "' ";
                cmd = new SqlCommand(sql, kon);
                cmd.ExecuteNonQuery();
                kon.Close();
        ...
        public void dataSuratMasuk()
        {
            ...
            listsuratmasuk.Columns.Add("Alamat Pengirim", 150, HorizontalAlignment.Left);
            ...
            {
                kon.Open();
                sql = "Select sm.nomorSurat, ts.jenisSurat, sm.prihalSM, convert(varchar(20), sm.tanggalSM,106) as [tanggal], sm.penerimaSM, sm.alamatSM, sm.pengirimSM FROM TipeSurat as ts, SuratMasuk as sm WHERE ts.kodeSurat = sm.kodeSurat";
                cmd = new SqlCommand(sql, kon);
                cmd.ExecuteNonQuery();
                ...
                while (baca.Read())
                {
                    ...
                    data1.SubItems.Add(baca["jenisSurat"].ToString());
                    data1.SubItems.Add(baca["prihalSM"].ToString());
                    data1.SubItems.Add(baca["tanggal"].ToString());

                    data1.SubItems.Add(baca["pengirimSM"].ToString());
                    data1.SubItems.Add(baca["alamatSM"].ToString());

                    data1.SubItems.Add(baca["penerimaSM"].ToString());
        ...
        public void dataSuratMasukCari()
        {
            ...
            {
                kon.Open();
                sql = "Select sm.nomorSurat, ts.jenisSurat, sm.prihalSM, convert(varchar(20), "+
                    "sm.tanggalSM,106) as [tanggal], sm.penerimaSM, sm.alamatSM, sm.pengirimSM "+
                    "FROM TipeSurat as ts, SuratMasuk as sm WHERE ts.kodeSurat = sm.kodeSurat and sm.nomorsurat like '%" + textBox5.Text + "%'";
                cmd = new SqlCommand(sql, kon);
                cmd.ExecuteNonQuery();
        ...
        //-----------------------------------------------------------
        /* komponen yang difungsikan untuk mengedit data */
        ...
        //-----------------------------------------------------------
        /* fungsi menampilkan data ke textbox */
        ...
        //-----------------------------------------------------------
        /* fungsi untuk mengambil gambar dari browser*/
        ...
        //-----------------------------------------------------------
        /* komponen yang berfungsi untuk melakukan proses penyimpanan data */
        ...
        //-----------------------------------------------------------
        /* digunakan untuk memindatakan data dari list view ke text box */
